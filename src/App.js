// Imports required components to run the app in the DOM 
import React, { Component } from 'react';
import characters from './characters.json';
import Wrapper from './components/Wrapper';
import LionKingCard from './components/LionKingCard';
import { Jumbotron , Button } from 'reactstrap';
import './App.css';

//Sets up the DOM state at the start of the game
class App extends Component {
  ...
  //Shuffle Array function that shuffles the character images from Character.js to the DOM
  shuffleArray = array => {
  ...
  //selectCharacter is called by onClick event in LionKingCard.js
  ...
  render() {
    return (
      <div>           
        <div className="App">
            <Jumbotron>
                <h2 className="App-title">Lion King Clicky Game</h2>
        ...
        <Wrapper>
            {
              ...
              //and pass to LionKingCard with key, character, charImage, currentScore and function selectCharacter 
